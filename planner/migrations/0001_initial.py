...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('planner', ['Calendar'])
        ...
        db.send_create_signal('planner', ['Location'])

        # Adding model 'Occurrence'
        db.create_table(u'occurrences', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['planner.Event'])),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('repeat', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('timeframe', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ...
        db.send_create_signal('planner', ['Occurrence'])

        # Adding model 'Reminder'
        db.create_table(u'reminders', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('planner', ['Reminder'])


    def backwards(self, orm):
        # Deleting model 'Calendar'
        db.delete_table(u'calendars')
        ...
        db.delete_table(u'occurrences')

        # Deleting model 'Reminder'
        db.delete_table(u'reminders')
    ...
    models = {
        ...
        'planner.calendar': {
            'Meta': {'object_name': 'Calendar', 'db_table': "u'calendars'"},
        ...
        'planner.occurrence': {
            'Meta': {'object_name': 'Occurrence', 'db_table': "u'occurrences'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'repeat': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
            'start_at': ('django.db.models.fields.DateField', [], {}),
            'timeframe': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        },
        'planner.reminder': {
            'Meta': {'object_name': 'Reminder', 'db_table': "u'reminders'"},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
